      ...
      <div className="flex-1 overflow-y-auto overflow-x-hidden p-5 space-y-4 bg-gradient-to-b from-[#111827]/50 to-[#0F172A]/50">
        {messages.length === 0 && (
          <div className="text-center text-[#9CA3AF] py-12">
            <div className="w-20 h-20 bg-gradient-to-br from-blue-400 to-indigo-500 rounded-full flex items-center justify-center mx-auto mb-4 shadow-[0_0_20px_rgba(96,165,250,0.3)] overflow-hidden p-2">
        ...
        {isLoading && messages[messages.length - 1]?.role === "user" && (
          <div className="flex gap-3 items-start animate-fade-in">
            <div className="w-9 h-9 bg-gradient-to-br from-blue-400 to-indigo-500 rounded-full flex items-center justify-center flex-shrink-0 shadow-[0_0_15px_rgba(96,165,250,0.3)] overflow-hidden p-1">
              <img src={auraAvatar} alt="AURA" className="w-full h-full object-cover" />
            </div>

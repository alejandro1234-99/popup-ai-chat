        ...
        {isProductCards ? (
          <div className="flex flex-col">
            <div className="flex items-center gap-2 mb-2">
              <div className="w-8 h-8 rounded-full flex items-center justify-center shadow-[0_0_15px_rgba(96,165,250,0.3)] overflow-hidden p-1" style={{ background: 'radial-gradient(circle at center, #1e293b 0%, #0f172a 100%)' }}>
